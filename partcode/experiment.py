...
def run_joined_models_tree(base_out_folder, base_in_folder, models_to_load, cur_fold, s):
    ...
    if cur_fold != -1:
        ...
        classes = pandas.read_csv(al.base_path + "class_labels.csv", sep=",", header=0, na_values=["?"])
...
if __name__ == "__main__":
    params_sys = eval(sys.argv[1])
        # {'seed': 0, 'base_folder': '/home/fabiofabris/results/LogisticRegression/', 'epochs': 150, 'fold': 0,
        #             'base_model': 'LogisticRegression'}
        # {'seed':0,'base_folder':'/home/fabiofabris/results_proj_2/gtex+kegg+pathdip+ppi+go+mashup/',
        #           'base_in_folder':'/home/fabiofabris/results_proj/', 'epochs':150, 'fold':0, 'models_to_load':
        #               ['gtex','kegg','pathdip','ppi','go','mashup'], 'base_model':'joined'}
    ...
    if params_sys["base_model"] == "module":
        ...
        dataset = dl.load_dataset(params_sys["feature_type"], binary_features=params_sys["binary_feature"])
    ...
    if params_sys["base_model"] == "joined_seq":
        ...
        run_joined_models(params_sys["base_folder"], params_sys["base_in_folder"], 
                selected_modules, params_sys["fold"], params_sys["epochs"], params_sys["seed"])
    # if params_sys["base_model"] == "concat":
    #
    ...
    if params_sys["base_model"] == "full_dataset":
        ...
        # ds = dl.add_feature_type(ds, "mashup_features.csv", binary_features=False)
        ...
        ds = dl.add_feature_type(ds, "kegg_features.csv", binary_features=True)
    ...
    if params_sys["base_model"] == "LogisticRegression":
        params = {}
        ...
        run_base_models(params_sys["base_folder"], params, params_sys["seed"], params_sys["fold"], ds,
                        classifier_builder=train_model.LRModel)
